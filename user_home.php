...
<div class="navbar">
  ...
  <button class="dropbtn" onclick="myFunction()">LOAN
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-content" id="myDropdown">
    <a href="/Loan-Management-system/loan/loan.php">Apply for loan</a>
    <a href="#">Types of loan</a>
    <a href="/Loan-Management-system/loan/loan_details.php">View Loan Details</a>
  </div>
  </div> 
